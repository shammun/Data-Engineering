...
def process_immigration_data(output):
    ...
    print("Immigration data is prepared now for uploading to S3")
    ...
    print("Immigration data has been uploaded to S3")
...
def process_label_data(output):
    ...
    print("Dimension table named Countries data is now being read and it will now be uploaded to S3")
    country = {}
    ...
    print("Countries data has been uploaded to S3")
    print()
    print()
    
    # Processing City data
    #logging.info("Dimension table named countries is now being read and it will now be uploaded to S3")
    print("Dimension table named cities is now being read and it will now be uploaded to S3")
    city = {}
    ...
    print("Cities data have been uploaded to S3")
    print()
    print()
    
    # Processing mode data
    #logging.info("Dimension table named mode is now being read and it will now be uploaded to S3")
    print("Dimension table named mode is now being read and it will now be uploaded to S3")
    mode = {}
    ...
    print("mode data has been uploaded to S3")
    print()
    print()
    
    # Processing state data
    #logging.info("Dimension table named state is now being read and it will now be uploaded to S3")
    print("Dimension table named state is now being read and it will now be uploaded to S3")
    state = {}
    ...
    print("state data has been uploaded to S3")
    print()
    print()
    
    # Processing visa data
    #logging.info("Dimension table named visa is now being read and it will now be uploaded to S3")
    print("Dimension table named visa is now being read and it will now be uploaded to S3")
    visa = {}
    ...
    print("visa data has been uploaded to S3")
    print()
    print()
...
def process_temperature_data(output):
    ...
    print("Creating table named temperature by reading a CSV file and then process it and upload as parquet files to S3")
    # Read the data
    ...
    temp_spark.write.mode("overwrite").parquet("{}{}".format(output, write_to_path["temperature"]))
    #logging.info("temperature data has been uploaded to S3")
    print("temperature data has been uploaded to S3")
    print()
    print()
...
def process_demographic_data(output):
    ...
    print("Creating table named demography by reading a CSV file and then process it and upload as parquet files to S3")
    # Read the data
    ...
    print("demographic data has been uploaded to S3")
    print()
    print()
